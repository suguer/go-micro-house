...
type UserVipModel struct {
	...
	Status float32 `protobuf:"fixed32,8,opt,name=Status,proto3" json:"Status,omitempty"`
}
...
func (x *UserVipModel) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *UserVipModel) GetStatus() float32 {
	if x != nil {
		return x.Status
	}
	return 0
...
var file_userVipModels_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x02, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x1b, 0x5a, 0x19,

...
type UserServiceClient interface {
	...
	LoginByWechat(ctx context.Context, in *LoginByWechatRequest, opts ...grpc.CallOption) (*UserDetailResponse, error)
	ModifyPassword(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *userServiceClient) LoginByWechat(ctx context.Context, in *LoginByWechatRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	out := new(UserDetailResponse)
	err := c.cc.Invoke(ctx, "/pb.UserService/LoginByWechat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) ModifyPassword(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.UserService/ModifyPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) Create(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	out := new(UserDetailResponse)
...
type UserServiceServer interface {
	...
	LoginByWechat(context.Context, *LoginByWechatRequest) (*UserDetailResponse, error)
	ModifyPassword(context.Context, *UserRequest) (*Response, error)
...
func (UnimplementedUserServiceServer) LoginByWechat(context.Context, *LoginByWechatRequest) (*UserDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginByWechat not implemented")
}
func (UnimplementedUserServiceServer) ModifyPassword(context.Context, *UserRequest) (*Response, error) {
...
func _UserService_LoginByWechat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginByWechatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).LoginByWechat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/LoginByWechat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).LoginByWechat(ctx, req.(*LoginByWechatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_ModifyPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/ModifyPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ModifyPassword(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_LoginByWechat_Handler,
		},
		{

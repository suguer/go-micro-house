...
type UserDetailResponse struct {
	...
	Platform   *UserPlatformModel `protobuf:"bytes,2,opt,name=Platform,proto3" json:"Platform,omitempty"`
...
var file_userService_proto_rawDesc = []byte{
	...
	0x08, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x28, 0x0d, 0x52, 0x04, 0x43, 0x6f, 0x64, 0x65, 0x32, 0x91, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65,
	...
	0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x06, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71,
...
var file_userService_proto_goTypes = []interface{}{
	...
	(*UserPlatformModel)(nil),  // 3: pb.UserPlatformModel
	(*UserVipModel)(nil),       // 4: pb.UserVipModel
}
var file_userService_proto_depIdxs = []int32{
	2, // 0: pb.UserDetailResponse.UserDetail:type_name -> pb.UserModel
	3, // 1: pb.UserDetailResponse.Platform:type_name -> pb.UserPlatformModel
	4, // 2: pb.UserDetailResponse.Vip:type_name -> pb.UserVipModel
	...
	0, // 7: pb.UserService.Update:input_type -> pb.UserRequest
	...
	1, // 12: pb.UserService.Update:output_type -> pb.UserDetailResponse
